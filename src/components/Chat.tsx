                  ...
                  {msg.media_type === 'snapshot' ? (
                    ...
                    >
                      ...
                      <div className="group relative rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl">
                        ...
                        <div className="group relative rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl bg-black max-w-[300px]">
                          <video 
                            src={msg.media_url} 
                            controls 
                        ...
                        <div className={`p-4 rounded-[2rem] border transition-all max-w-[280px] ${
                          isMe ? "bg-indigo-600/20 border-indigo-500/30" : "bg-white/[0.03] border-white/5"
                        }`}>
                          <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isMe ? 'bg-indigo-500' : 'bg-white/10'}`}>
                              <Mic className="w-5 h-5 text-white" />
                            </div>
                            <audio 
                              src={msg.media_url} 
                              controls 
                              className="h-8 w-40 filter invert dark:invert-0"
                            />
                          </div>
                        </div>
